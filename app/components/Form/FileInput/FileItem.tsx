    ...
    variants: {
        state: {
            ...
            error: {
                ...
                deleteButton: 'group text-error-700 hover:text-error-900 dark:text-error-400 dark:hover:text-error-300',
            },
        }
    },
...
export function FileItem({ name, size, state }: FileItemProps) {
    ...
    const { handleDeleteFile } = useFileInput()
    ...
    return (
        <div className={container()}>
                ...
                <div className="flex flex-1 flex-col items-start gap-1">
                    ...
                    <div className="flex w-full items-center gap-3">
                        <div className="h-2 flex-1 rounded-full bg-zinc-100 dark:bg-zinc-600">
                            <div className="h-2 rounded-full bg-violet-600 w-4/5 dark:bg-violet-400" style={{ width: state === 'complete' ? '100%' : '80%' }} />
                        </div>
            ...
            {state === 'complete' ? (
                ...
                <Button type="button" variant="ghost" className={deleteButton()} onClick={() => handleDeleteFile(name)}>
